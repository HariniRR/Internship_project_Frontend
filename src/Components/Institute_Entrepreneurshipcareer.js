...
const Institute_Entrepreneurshipcarrer = () => {
    ...
    return (
        <div className="container ">
            <h4 className="mt-3 text-primary">Entrepreneurship Development/Career Guidance Higher Education Cell Activities</h4>
...
export default Institute_Entrepreneurshipcarrer;
